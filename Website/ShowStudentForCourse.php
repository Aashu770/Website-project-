...
$showTable="SELECT * FROM Student INNER JOIN Student_Course ON Student.Student_ID=Student_Course.Student_ID Where Term= '".$_POST['Term_Name']."' AND Course_Id = '".$_POST['Courseid']."'";
