...
$showTable="SELECT * FROM Course INNER JOIN Student_Course ON Course.Course_ID=Student_Course.Course_ID Where Term= '".$_POST['Term_Name']."' AND Department = '".$_POST['Dept_Name']."'";
